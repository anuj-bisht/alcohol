        ...
        <div class="col-lg-12" id="product_image">
            ...
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <span>
                    <i class="tim-icons icon-simple-remove image{{$productimages->id}}" onclick="deleteImage({{$productimages->id}})"></i>

                    <img class="image{{$productimages->id}}" style="width:200px; height:150px;" src="{{asset($productimages->images)}}">
                    </span>
        ...
        dangerMode: true,
                ...
                if (willDelete) {
                    $.ajax({
                        ...
                        url:"{{URL::to('Product/deleteimage')}}/"+id,
